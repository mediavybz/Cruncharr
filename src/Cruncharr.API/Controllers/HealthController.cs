...
public class HealthController : ControllerBase
{
    ...
    public ActionResult<HealthResponse> GetHealth()
    {
        try
        {
            ...
            {
                Status = "healthy",
                Version = GetType().Assembly.GetCustomAttributes(typeof(System.Reflection.AssemblyInformationalVersionAttribute), false).Cast<System.Reflection.AssemblyInformationalVersionAttribute>().FirstOrDefault()?.InformationalVersion ?? "1.0.69",
