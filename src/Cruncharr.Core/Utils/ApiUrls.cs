...
public static class ApiUrls{
    ...
    public static string Auth(bool useBetaApi) => (useBetaApi ? ApiBeta : ApiN) + "/auth/v1/token";
    public static string Profile(bool useBetaApi) => (useBetaApi ? ApiBeta : ApiN) + "/accounts/v1/me/profile";
    public static string MultiProfile(bool useBetaApi) => (useBetaApi ? ApiBeta : ApiN) + "/accounts/v1/me/multiprofile";
    ...
    public static string Subscription(bool useBetaApi) => (useBetaApi ? ApiBeta : ApiN) + "/subs/v3/subscriptions/";
